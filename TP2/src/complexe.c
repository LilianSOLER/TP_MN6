...
void test_mult_float(){
  ...
  for(int i = 0; i < 100; i++){
    float x1 = ((float)rand()/(float)(RAND_MAX)) * a;float y1 = ((float)rand()/(float)(RAND_MAX)) * a;// create random number to generate random complexe number xi are real part 
    float x2 = ((float)rand()/(float)(RAND_MAX)) * a;float y2 = ((float)rand()/(float)(RAND_MAX)) * a; // and yi are imaginary part
...
void test_mult_double(){
  ...
  for(int i = 0; i < 100; i++){
    double x1 = ((double)rand()/(double)(RAND_MAX)) * a;double y1 = ((double)rand()/(double)(RAND_MAX)) * a;// create random number to generate random complexe number xi are real part 
    double x2 = ((double)rand()/(double)(RAND_MAX)) * a;double y2 = ((double)rand()/(double)(RAND_MAX)) * a; // and yi are imaginary part
